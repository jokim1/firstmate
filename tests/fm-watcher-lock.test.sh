...
SH
  ...
  # settles (issue #2844).
  PATH="$fakebin:$PATH" FM_STATE_OVERRIDE="$state" FM_GUARD_GRACE=0 FM_POLL=5 FM_SIGNAL_GRACE=1 FM_CHECK_INTERVAL=0 FM_HEARTBEAT=999999 FM_ARM_CONFIRM_TIMEOUT=60 FM_WAKE_POST_OUTPUT_ACTION="$post_output" FM_TEST_POST_OUTPUT_READY="$post_output_ready" "$WATCH_ARM" > "$armout" || rc=$?

...
| portable serial 1-7 | job `timeout-minutes: 20` | Each balanced shard carries about 13.45 minutes of conservative assignment weight, leaving roughly 1.5x hang-tripwire margin for job setup and runner-speed spread. |

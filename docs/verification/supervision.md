...
The current Stop-owned main/secondmate inclusion, child-worktree exclusion, and queue-only idle-secondmate cycle are covered deterministically by `tests/fm-claude-stop-autoarm.test.sh`.

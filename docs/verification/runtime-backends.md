...
A 2026-09-09 Kimi Code 0.41.0 cursorless Herdr capture verified that first-message session creation can leave the pointer pending in its bordered box above `thinking` and `context` status rows.

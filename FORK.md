...
Each patch carries a retire-when condition, and the private home named above decides retirement, requiring proof and per-item approval rather than apparent upstream coverage.

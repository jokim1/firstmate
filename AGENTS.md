...
- `spec-writing` - load before writing, updating, or checking any human-facing spec, design page, research report, how-to guide, reference, decision record, status report, or wiki page, and before scaffolding a brief for one.

...
family_for_basename() {
  case "$1" in
    ...
    fm-focus-hook-live-e2e.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-claude-herdr-live-e2e.test.sh 98
tests/fm-afk-contract.test.sh 10142
tests/fm-afk-inject-e2e.test.sh 35792
tests/fm-afk-pi-herdr-return-e2e.test.sh 100
tests/fm-afk-return.test.sh 15765
tests/fm-ask-user-authority.test.sh 128
tests/fm-backend-cmux-smoke.test.sh 33
tests/fm-backend-cmux.test.sh 3763
tests/fm-backend-orca.test.sh 19950
tests/fm-backend-tmux-smoke.test.sh 393
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 9496
tests/fm-backend.test.sh 20571
tests/fm-backlog-atomicity.test.sh 151132
tests/fm-backlog-handoff.test.sh 52744
tests/fm-bearings-board-lavish-live-e2e.test.sh 39
tests/fm-bearings-board-render.test.sh 16469
tests/fm-bearings-board.test.sh 59622
tests/fm-bearings-snapshot.test.sh 106742
tests/fm-bootstrap-network-parallel.test.sh 9197
tests/fm-bootstrap.test.sh 80192
tests/fm-branch-supervision.test.sh 8984
tests/fm-busy-adapter-wiring.test.sh 26900
tests/fm-busy-state.test.sh 3039
tests/fm-calm-pi-extension.test.sh 51253
tests/fm-check-unregister.test.sh 481
tests/fm-classify-corr-token.test.sh 38742
tests/fm-classify-decision-key.test.sh 1184
tests/fm-claude-stop-autoarm-live-e2e.test.sh 43
tests/fm-claude-stop-autoarm.test.sh 60709
tests/fm-claude-trust.test.sh 5898
tests/fm-cmux-claude-composer-live-e2e.test.sh 45
tests/fm-codex-continuity-live-e2e.test.sh 35
tests/fm-composer-matrix-live-e2e.test.sh 73
tests/fm-control-relaunch.test.sh 112440
tests/fm-control.test.sh 52023
tests/fm-cursor-harness.test.sh 30234
tests/fm-cursor-primary-live-e2e.test.sh 83
tests/fm-cursor-primary.test.sh 54947
tests/fm-daemon.test.sh 29523
tests/fm-documentation-audiences.test.sh 833
tests/fm-extension-binding.test.sh 21118
tests/fm-fleet-snapshot-view.test.sh 8547
tests/fm-fleet-sync.test.sh 63266
tests/fm-focus-hook-live-e2e.test.sh 81
tests/fm-focus.test.sh 7338
tests/fm-gate-refuse.test.sh 5326
tests/fm-gemini-harness.test.sh 1649
tests/fm-gitignore-config.test.sh 62
tests/fm-gotmp.test.sh 1646
tests/fm-grok-continuity-live-e2e.test.sh 43
tests/fm-grok-stop-live-e2e.test.sh 43
tests/fm-guard-stale-banner.test.sh 11342
tests/fm-harness-adapter-instructions-live-e2e.test.sh 42
tests/fm-harness-adapter-references.test.sh 58
tests/fm-harness-liveness-drift-live-e2e.test.sh 883
tests/fm-herdr-session-cleanup.test.sh 6704
tests/fm-herdr-submit-confirm-live-e2e.test.sh 74
tests/fm-herdr-version-floor-live-e2e.test.sh 73
tests/fm-home-summary-refresh.test.sh 36180
tests/fm-inactive-reconcile.test.sh 91441
tests/fm-kimi-harness.test.sh 18572
tests/fm-lint-workflows.test.sh 855
tests/fm-live-gate.test.sh 6000
tests/fm-muse-harness.test.sh 65190
tests/fm-muse-signals-live-e2e.test.sh 101
tests/fm-nm-test-contract.test.sh 642
tests/fm-no-mistakes-required.test.sh 370
tests/fm-omp-harness.test.sh 62704
tests/fm-omp-primary-live-e2e.test.sh 43
tests/fm-on.test.sh 33379
tests/fm-opencode-primary-live-e2e.test.sh 96
tests/fm-operational-input.test.sh 231
tests/fm-peek-remote.test.sh 1018
tests/fm-pending-reply.test.sh 67828
tests/fm-pi-branch-extension.test.sh 61639
tests/fm-pi-branch-live-e2e.test.sh 81
tests/fm-pi-branch-responsiveness-live-e2e.test.sh 13041
tests/fm-pi-codex-native.test.sh 157
tests/fm-pi-primary-live-e2e.test.sh 80
tests/fm-pi-watch-extension.test.sh 51527
tests/fm-pi-windows-shell-invocation.test.sh 5121
tests/fm-playbot-backend.test.sh 2344
tests/fm-playbot-lanes.test.sh 10296
tests/fm-playbot-reconcile.test.sh 2555
tests/fm-pr-check-security.test.sh 166026
tests/fm-procevent-quota.test.sh 2017
tests/fm-procevent-when.test.sh 20428
tests/fm-procevent.test.sh 72894
tests/fm-project-origin.test.sh 600
tests/fm-public-followup.test.sh 196745
tests/fm-quota-array-dispatch-live-e2e.test.sh 43
tests/fm-quota-choose.test.sh 1461
tests/fm-remote-backlog-handoff.test.sh 121216
tests/fm-remote-doctor.test.sh 5198
tests/fm-remote-entrypoint.test.sh 161
tests/fm-remote-job-orphan-reap.test.sh 2982
tests/fm-remote-job.test.sh 59603
tests/fm-remote-reply.test.sh 101690
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 220303
tests/fm-remote-secondmate-parent-binding.test.sh 30894
tests/fm-remote-secondmate-trace-context.test.sh 67096
tests/fm-remote-transport-lanes.test.sh 63868
tests/fm-rovo-harness.test.sh 13565
tests/fm-rovo-signals-live-e2e.test.sh 98
tests/fm-secondmate-harness.test.sh 156167
tests/fm-secondmate-lifecycle-e2e.test.sh 8793
tests/fm-secondmate-liveness.test.sh 18146
tests/fm-secondmate-reconcile.test.sh 97814
tests/fm-secondmate-restart.test.sh 42233
tests/fm-secondmate-safety.test.sh 60113
tests/fm-secondmate-sync.test.sh 89342
tests/fm-send-inbox-doorbell-live-e2e.test.sh 98
tests/fm-send-inbox.test.sh 38956
tests/fm-send-remote-delivery.test.sh 27686
tests/fm-send-resolve-key.test.sh 29002
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 51
tests/fm-send-secondmate-marker.test.sh 18725
tests/fm-session-lock-ancestry.test.sh 1439
tests/fm-session-start.test.sh 160537
tests/fm-sessionstart-hook-live-e2e.test.sh 73
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 43
tests/fm-sessionstart-nudge.test.sh 66194
tests/fm-shared-captain-inheritance.test.sh 6223
tests/fm-spawn-dispatch-profile.test.sh 118360
tests/fm-spawn-foreign-marker-scrub.test.sh 48076
tests/fm-spawn-pool-base-freshen.test.sh 54769
tests/fm-spawn-worktree-settle.test.sh 8247
tests/fm-startup-memory-budget.test.sh 6964
tests/fm-startup-network.test.sh 62084
tests/fm-stat-shadowing.test.sh 46
tests/fm-status-gc.test.sh 34254
tests/fm-stow-cascade.test.sh 3101
tests/fm-subagent-pretool-check.test.sh 1141
tests/fm-supervision-events.test.sh 719
tests/fm-tangle-guard.test.sh 9662
tests/fm-task-delivery.test.sh 11759
tests/fm-task-inbox.test.sh 48490
tests/fm-teardown-endpoint-safety.test.sh 31701
tests/fm-teardown-husk.test.sh 7121
tests/fm-teardown.test.sh 168977
tests/fm-test-fixture-cleanup.test.sh 915
tests/fm-test-fixtures.test.sh 194
tests/fm-test-isolation-proof.test.sh 2567
tests/fm-tmux-agent-liveness.test.sh 2079
tests/fm-tool-update-check.test.sh 14176
tests/fm-trace-context-lib.test.sh 209
tests/fm-trace-context-spawn.test.sh 46897
tests/fm-treehouse-pool-isolation.test.sh 9476
tests/fm-turnend-guard.test.sh 42565
tests/fm-update.test.sh 9843
tests/fm-vendor-auth-probe.test.sh 45230
tests/fm-voice-relay.test.sh 32955
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7816
tests/fm-wake-drain-open-decisions-cursor.test.sh 67029
tests/fm-wake-drain-open-decisions.test.sh 6885
tests/fm-wake-drain-outcome-backstop.test.sh 45331
tests/fm-wake-drain-unread-status.test.sh 39823
tests/fm-wake-queue.test.sh 100819
tests/fm-watch-arm.test.sh 96146
tests/fm-watch-checkpoint.test.sh 8085
tests/fm-watch-recovery-loop.test.sh 61623
tests/fm-watch-triage.test.sh 607447

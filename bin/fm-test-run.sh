...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-claude-herdr-live-e2e.test.sh 60
...
tests/fm-focus-hook-live-e2e.test.sh 43
tests/fm-focus.test.sh 7111
...
tests/fm-pi-branch-extension.test.sh 52427
...
tests/fm-remote-backlog-handoff.test.sh 41887
...
tests/fm-secondmate-harness.test.sh 152497
...
tests/fm-secondmate-restart.test.sh 37037
...
tests/fm-spawn-dispatch-profile.test.sh 65662
tests/fm-spawn-foreign-marker-scrub.test.sh 48076
tests/fm-spawn-pool-base-freshen.test.sh 36583
tests/fm-spawn-worktree-settle.test.sh 5690
tests/fm-startup-memory-budget.test.sh 6964
tests/fm-startup-network.test.sh 62084
tests/fm-status-gc.test.sh 33466
...
tests/fm-task-inbox.test.sh 36427
tests/fm-teardown-endpoint-safety.test.sh 4976
tests/fm-teardown-husk.test.sh 7121
tests/fm-teardown.test.sh 122231
tests/fm-test-fixture-cleanup.test.sh 915
tests/fm-test-fixtures.test.sh 157
tests/fm-test-isolation-proof.test.sh 2567
tests/fm-tmux-agent-liveness.test.sh 1788
...
tests/fm-vendor-auth-probe.test.sh 43318
tests/fm-voice-relay.test.sh 28933
...
tests/fm-watch-arm.test.sh 90814
tests/fm-watch-checkpoint.test.sh 5779
tests/fm-watch-recovery-loop.test.sh 58871
tests/fm-watch-triage.test.sh 385847

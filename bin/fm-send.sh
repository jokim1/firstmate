...
# harness meta, get a longer backend-specific settle around the first submit
# so completion popups do not swallow it. A remote secondmate target has no
# typed text plane at all:

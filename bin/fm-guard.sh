...
# is a genuine lapse; under every persistent-watcher harness a live
# identity-matched watcher with a fresh beacon is required. The banner names the
# true failing condition (a missing live watcher process vs a genuinely stale
# beacon). The full banner is emitted once per distinct down-episode in this
# FM_HOME (keyed to the failing condition, not the beacon mtime, which a healthy
# between-turns watcher advances every poll); later guarded commands in the same
# episode print a one-line reminder instead.
  ...
  if [ "$print_full_banner" -eq 1 ]; then
    ...
    rule='━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
    {
      ...
      if [ "$in_flight" -gt 0 ]; then
        ...
        printf '●  Queued wakes need handling, but %s.\n' "$watcher_cause"
      else

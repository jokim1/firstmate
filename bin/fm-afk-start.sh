...
#   Internal entry; requires FM_AFK_LAUNCH_PROVENANCE=separate-terminal (set by
#   the launcher). Sets state/.afk (mode preserved on refresh, see
#   fm_afk_flag_write), checks state/.supervise-daemon.lock, and:

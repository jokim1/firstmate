...
# that trace is present. It is a strong signal of unfinished cleanup rather than
# a complete endpoint check - a spawn that died before its temp root was created, or
